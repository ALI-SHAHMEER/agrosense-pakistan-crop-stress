...
NDVI\_std, NDVI\_min, NDVI\_max), collected from 99 georeferenced agricultural
sampling locations across all four provinces of Pakistan spanning 19 crop-season
windows (2015--2024). Feature scaling via \texttt{StandardScaler} is applied
inside a \texttt{Pipeline} for SVM and $k$-NN; tree-based models receive raw
features.
